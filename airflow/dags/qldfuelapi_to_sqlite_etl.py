...
def transform_fuel_sites():
    ...
    fuel_sites_df['latitude'] = pd.to_numeric(df['Lat'])
    fuel_sites_df['longitude'] = pd.to_numeric(df['Lng'])
    ...
    fuel_sites_df['api_last_modified'] = pd.to_datetime(df['M'], format='ISO8601')
