...
<!doctype html>
<html lang="en" xmlns="http://www.w3.org/1999/html" class="h-full bg-gray-100">
<script src="https://cdn.tailwindcss.com"></script>
<head>

    <title>Fuel Hunter</title>
            ...
            <div class="flex h-16 items-center justify-between">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <img class="h-8 w-8 rounded-full" src="{{asset("storage/AppLogo/FUELLOGO.png")}}"
                             alt="Your Company">
                    </div>
                ...
                <div class="hidden md:block flex items-center justify-between">
                    ...
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        @auth
                            <div class="m-1">
                                <x-nav-link :active="request()->is('tool')" href="/tool">Tools</x-nav-link>
                            </div>
                            <div class="m-1">
